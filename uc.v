module UnidadeControle (
    ...
    typedef enum reg [5:0] {
        ...
        J_1,
        JAL_1,JAL_2,
        EXCEPTION_1,EXCEPTION_2,EXCEPTION_3,EXCEPTION_4,EXCEPTION_5,
    ...
    always @(*) begin
        case (state)
            ...
            ESPERA_MD: begin
                //if (div_zero) 
                    //next_state = EXC_DIV_ZERO; // Se dividir por zero, dá erro imediatamente
                if (ready) 
            ...
            SUB_1: next_state = SUB_2;SUB_2: next_state = SUB_3;SUB_3: next_state = FETCH_1;
            // Caminho AND (3 ciclos)
            AND_1: next_state = AND_2;AND_2: next_state = AND_3;AND_3: next_state = FETCH_1;
            // Caminho ADD (3 ciclos)
            ADD_1: next_state = ADD_2;ADD_2: next_state = ADD_3;ADD_3: next_state = FETCH_1;
            ...
            ADDI_1: next_state = ADDI_2;ADDI_2: next_state = ADDI_3;ADDI_3: next_state = FETCH_1;
            // Caminho SB (5 Ciclos)
            ...
            // Caminho Exceção (3 ciclos)
            EXCEPTION_1: next_state = EXCEPTION_2; EXCEPTION_2: next_state = EXCEPTION_3; EXCEPTION_3: next_state = EXCEPTION_4;
            EXCEPTION_4: next_state = EXCEPTION_5; EXCEPTION_5: next_state = FETCH_1;
